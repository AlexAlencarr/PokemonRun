...
const loop = setInterval(() => {
    ...
    const colisao = setInterval(() => {
        ...
        if ((pokeballPosition >= 510 && pikachuPosition < 20) || (ultraballPosition >= 510 && pikachuPosition < 20) || (masterballPosition >= 510 && pikachuPosition < 20)) {
            //LINHAS DE CÓDIGO CRIADAS COM O OBJETIVO DE
            PARAR A ANIMAÇÃO DA POKEBOLA E FIXÁ-LA NA POSIÇÃO EM QUE TOCOU NO POKÉMON, VARIANDO CONFORME O TIPO DA POKEBOLA
